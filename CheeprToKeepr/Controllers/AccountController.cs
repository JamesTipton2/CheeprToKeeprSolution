...
namespace CheeprToKeepr.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(CheeprToKeeprContext db, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager)
        {
            _db = db;
